 ...
 */
const CACHE_VERSION = 'psychtrix-v3';
const SHELL = ['/', '/index.html', '/manifest.webmanifest', '/favicon-32.png', '/favicon-48.png', '/icon-192.png', '/icon-512.png', '/icon-512-maskable.png', '/apple-touch-icon.png'];
